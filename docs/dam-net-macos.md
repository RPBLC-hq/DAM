...
The Network Extension state record stores the activated bundle identifier, optional team identifier, configured AI hosts, and activation method. It is only written after the native helper succeeds.
